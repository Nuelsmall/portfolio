...
const Hero = () => {
  ...
  return (
    <div id="home" className="flex scroll-mt-24 p-10 flex-col gap-5 items-center">
      <h1 className="text-6xl font-semibold max-w-230 leading-18 text-center">
        <span className="text-gray-500">Good design </span> solves problems.{" "}
        <span className="text-gray-500"> Great design</span> travels.
      </h1>
      <p className="text-xl leading-7 text-gray-500 max-w-150 text-center">
      ...
      <div className="w-full flex items-center justify-center mt-10 relative max-w-339 overflow-hidden h-140  ">
          ...
          <div className="flex shrink-0  gap-4 pr-4" ref={groupRef}>
            {carouselItems.map((_, i) => {
              return (
                ...
                >
                  <Image src={_} alt="" className="w-full h-full" width={200} height={200} />
                </div>
              );
            })}
          </div>{" "}
